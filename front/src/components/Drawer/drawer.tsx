...
const Drawer = () => {
  ...
  return (
    <div>
      ...
      <div
        className={`fixed top-0 left-0 h-full w-64 bg-sky-800 text-white flex flex-col transform ${
      ...
      >
        <div className="p-4">
          ...
          <ul className="mt-2">
            <div onClick={handleClickHome} className="mb-4 flex items-center">
              <HomeIcon/>
              <li className="text-center">Inicio</li>
            </div>
            <div onClick={handleClickBooking} className="mb-4 flex items-center">
              <BookingIcon />
